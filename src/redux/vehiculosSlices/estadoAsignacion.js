import { estadoAsingacionInicialState } from '../initialStates/estadoAsignacion.js'

const estadoAsignacionSlice = (state = estadoAsingacionInicialState, action) => {
...
export default estadoAsignacionSlice
