...
import { setKilometraje, setSelectedPlace, setImage, setModelo, setPlaca, setVehiculo, setMarca, setSerie, setColor, setColorLlavero, setTipoMotor } from "../../../redux/vehiculosSlices/informacionGeneralSlice.js"
...
const Title = ({ setAnimation }) => {
	...
	const ResetData = () => {
		dispatch(setKilometraje('')); dispatch(setSelectedPlace('')); dispatch(setImage(null)); dispatch(setModelo('')); dispatch(setPlaca('')); dispatch(setVehiculo('')); dispatch(setSerie('')); dispatch(setMarca('')); dispatch(setColor('')); dispatch(setColorLlavero('')); dispatch(setTipoMotor(''));
