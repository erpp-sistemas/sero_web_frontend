...
const DocumentoIndividual = ({ label, onClick, fileRef, onChange, nombreDocumento, error }) => (
	...
	<Box sx={{ height: '300px', display: 'flex', justifyContent: 'start', alignItems: 'center', flexDirection: 'column' }}>
		...
		<Button
			sx={{ width: '170px', height: '170px', background: 'rgba(0,0,0,0.2)', mt: '10px', borderRadius: '10px', border: !error ? '1px solid #fff' : '1px solid red', justifyContent: 'center', alignItems: 'center' }}
			onClick={onClick}
		>
			{nombreDocumento ? (
