...
function Pdf2({ ownerDetails, ownerHomeImages, ownerDebts, ownerPayments, ownerActions }) {
				...
				<View style={styles.section}>
					...
					<View style={styles.table}>
						...
						{ownerHomeImages.length > 0 ? (
							...
							chunkArray(ownerHomeImages.slice(0, 9), 3).map((imageRow, rowIndex) => (
			...
			{ownerHomeImages.slice(9, 18).length > 0 ? (
				...
				>
					...
					<View style={styles.section}>
						...
						{ownerHomeImages.length > 0 ? (
							chunkArray(ownerHomeImages.slice(9, 18), 3).map((imageRow, rowIndex) => (
...
Pdf2.propTypes = {
	...
	ownerDebts: PropTypes.func.isRequired,
}
