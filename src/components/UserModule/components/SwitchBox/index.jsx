      ...
      return (
        <>
          ...
          >
                    ...
                    <FormControlLabel
                      control={
                        <Checkbox
                          color="secondary"
                          checked={
                            selectedServices[service.id_servicio] || false
                          }
                          onChange={() =>
                            handleServiceSelection(service.id_servicio)
                          }
                        />
                      }
            ...
            {selectedServices["1"] && buttons["button1"] && (
              <Box
                sx={{
                  border: "1px solid white",
                  margin: "1rem",
            ...
            {selectedServices["2"] && buttons["button1"] && (
              <Box
                sx={{
                  border: "1px solid white",
                  margin: "1rem",
            ...
            {selectedServices["3"] && buttons["button1"] && (
              <Box
                sx={{
                  border: "1px solid white",
                  margin: "1rem",
            ...
            {selectedServices["4"] && buttons["button1"] && (
              <Box
                sx={{
                  border: "1px solid white",
                  margin: "1rem",
            ...
            {selectedServices["1"] && buttons["button2"] && (
              <Box
                sx={{
                  border: "1px solid white",
                  margin: "1rem",
            ...
            {selectedServices["2"] && buttons["button2"] && (
              <Box
                sx={{
                  border: "1px solid white",
                  margin: "1rem",
            ...
            {selectedServices["3"] && buttons["button2"] && (
              <Box
                sx={{
                  border: "1px solid white",
                  margin: "1rem",
            ...
            {selectedServices["4"] && buttons["button2"] && (
              <Box
                sx={{
                  border: "1px solid white",
                  margin: "1rem",
            ...
            {selectedServices["1"] && buttons["button3"] && (
              <Box
                sx={{
                  border: "1px solid white",
                  margin: "1rem",
            ...
            {selectedServices["2"] && buttons["button3"] && (
              <Box
                sx={{
                  border: "1px solid white",
                  margin: "1rem",
            ...
            {selectedServices["3"] && buttons["button3"] && (
              <Box
                sx={{
                  border: "1px solid white",
                  margin: "1rem",
            ...
            {selectedServices["4"] && buttons["button3"] && (
              <Box
                sx={{
                  border: "1px solid white",
                  margin: "1rem",
            ...
            {selectedServices["1"] && buttons["button4"] && (
              <Box
                sx={{
                  border: "1px solid white",
                  margin: "1rem",
            ...
            {selectedServices["2"] && buttons["button4"] && (
              <Box
                sx={{
                  border: "1px solid white",
                  margin: "1rem",
            ...
            {selectedServices["3"] && buttons["button4"] && (
              <Box
                sx={{
                  border: "1px solid white",
                  margin: "1rem",
            ...
            {selectedServices["4"] && buttons["button4"] && (
              <Box
                sx={{
                  border: "1px solid white",
                  margin: "1rem",
