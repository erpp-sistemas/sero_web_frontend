...
export default function LinearProgressWithLabel(props) {
	...
	return (
		...
		<Box sx={{ position:'absolute', width:'100%', height:'100vh', display: 'flex', alignItems: 'center', top:'0px', left:'0', zIndex:'20000', background:'rgba(0, 0, 0, 0.42)', flexDirection:'column', justifyContent:'center' }}>
			...
			<Box sx={{ width: '100px', display: 'flex', alignItems: 'center', flexDirection:'column', justifyContent:'center' }}>
				<Typography variant="body2" color="text.secondary" sx={{ color: "#fff", fontWeight: '700', fontSize: '2rem' }}>{`${Math.round(props?.value,)}%`}</Typography>
			</Box>
