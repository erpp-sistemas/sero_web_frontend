...
function Index() {
  ...
  const [formDataTwo, setFormDataTwo] = React.useState(null);
  const [formDataThree, setFormDataThree] = React.useState(null);
  ...
  const handleStepTwoNext = (formDataTwo) => {
    ...
    console.log('profile_id:',formData.profile_id)
