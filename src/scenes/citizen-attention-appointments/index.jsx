...
import { citizenAttentionAppointmentsRequest } from "../../api/appointment.js";
import FullCalendarAppointments from "../../components/CitizenAttentionAppointments/FullCalendarAppointments.jsx";
import AppointmentSummaryCards from "../../components/CitizenAttentionAppointments/AppointmentSummaryCards.jsx";
...
function Index() {
  ...
  const handleGetCitizenAttentionAppointments = () => {
    if (
      !selectedPlace ||
      !selectedService ||
      !selectedStartDate ||
    ...
    citizenAttentionAppointmentsRequest(
      selectedPlace,
      selectedService,
      selectedStartDate,
      selectedFinishDate
  ...
  return (
    <div className="p-4 font-[sans-serif]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-1 gap-4">
        ...
        >
          Reporte citas de atencion ciudadana
        </Typography>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        ...
        <div>
          <Button
            variant="contained"
            onClick={() => {
              handleGetCitizenAttentionAppointments();
            }}
            sx={{
              width: "100%",
      ...
      <div className="grid grid-cols-1 md:grid-cols-1 gap-4">
        <FullCalendarAppointments data={resultData} />
      </div>
    </div>
  );
}
