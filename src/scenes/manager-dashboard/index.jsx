...
import { monthlyPaymentsDataNivo} from '../../data/ManagerDashboard/manager-dashboard-nivo.js'
import { monthlyPaymentsDataLightWeight} from '../../data/ManagerDashboard/manager-dashboard-ligthweight.js'
import Legend from '../../components/LightweightCharts/Legend.jsx'
import DailyPaymentEntry from '../../components/ManagerDashboard/DailyPaymentEntry.jsx'
import ChartExample from '../../components/ManagerDashboard/ChartExample.jsx'
import TableExample from '../../components/ManagerDashboard/TableExample.jsx'
    ...
    const paymentsData = [
      {
        ...
        color: 'red', // Color para la serie
        payments: [
          { time: '2024-08-01', value: 100 },
          { time: '2024-08-02', value: 120 },
          // Más datos...
        ],
      },
      {
		...
		<Box sx={{ margin:'20px' }}>
			...
			>
				...
				<Grid xs={12} container spacing={2}>
					<Grid item xs={12}>
						<MonthlyPayments data={ monthlyPaymentsDataNivo } typeConcept={ typeMonthlyPaymentsData }/>
					</Grid>
				</Grid>
        <Grid xs={12} container spacing={2}>
        <Grid item xs={12}>
          <Box sx={{ width: '100%', height: '500px' }}> {/* Ajuste de tamaño */}
            <DailyPaymentEntry data={monthlyPaymentsDataLightWeight} />
          </Box>
        </Grid>
				</Grid>
				<Grid xs={12} container spacing={2}>
					<Grid item xs={12}>
            <Legend data= {initialData}>
