...
const Login = ({ setLogin }) => {
	...
	},[isAuthenticated, navigate, setLogin])
				...
				<div className="flex justify-center self-center z-10 ml-10">
					...
					<div className="p-12 bg-gray-50 mx-auto rounded-2xl w-100 border-2 border-green-500">
						...
						<div className="pt-5 text-center text-gray-400 text-xs">
							<span>Copyright © 2022-2023 <a href="https://erpp.mx" rel="noreferrer" target="_blank" title="Ser0" className="text-blue hover:text-blue-500 ">SER0</a></span>
						</div>
